...
\begin{frame}
  ...
  \vspace{-4ex}
  \begin{center}
    \includegraphics[align=c,width=0.4\linewidth]{figures/FCC_hh_LAr_diagram.png}%
    \hfill
    \includegraphics[align=c,width=0.4\linewidth]{figures/FCC_ee_LAr_diagram.png}\\[.5em]
    FCC-hh \hspace{18em} FCC-ee
  \end{center}
\end{frame}
